...
apps = s.get('https://erpnext.karavanimports.com/api/resource/Connected%20App',
...
if apps.get('data'):
    ...
    full = s.get(f'https://erpnext.karavanimports.com/api/resource/Connected%20App/{name}', timeout=15).json().get('data', {})
    print("\nFull Connected App:")
