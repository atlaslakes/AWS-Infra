...
users = s.get('https://erpnext.karavanimports.com/api/resource/User',
...
r = s.put('https://erpnext.karavanimports.com/api/resource/Email%20Account/Karavan%20Imports',
          json={"connected_user": target}, timeout=15)
print(f"Update: {r.status_code}")
ea = s.get('https://erpnext.karavanimports.com/api/resource/Email%20Account/Karavan%20Imports', timeout=15).json().get('data', {})
