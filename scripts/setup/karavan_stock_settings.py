...
s.post("https://erpnext.karavanimports.com/api/method/login",
...
r = s.put("https://erpnext.karavanimports.com/api/resource/Stock%20Settings/Stock%20Settings",
...
wh_resp = s.get("https://erpnext.karavanimports.com/api/resource/Warehouse",
...
if store_wh:
    r2 = s.put("https://erpnext.karavanimports.com/api/resource/Stock%20Settings/Stock%20Settings",
...
existing = s.get("https://erpnext.karavanimports.com/api/resource/Property%20Setter",
...
if existing:
    ...
    r3 = s.put(f"https://erpnext.karavanimports.com/api/resource/Property%20Setter/{requests.utils.quote(name, safe='')}",
               json=ps_body, timeout=20)
    print(f"  Updated existing Property Setter : {r3.status_code}")
else:
    r3 = s.post("https://erpnext.karavanimports.com/api/resource/Property%20Setter",
                json=ps_body, timeout=20)
